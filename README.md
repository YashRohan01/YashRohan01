...
- **Time Series Analysis** for predictive intelligence  
- **Linear Algebra** foundations for robust AI models  

🧠 Research Interests:
- Robustness in ML models against adversarial attacks  
- Time Series Analysis in the domain of healthcare
- Generative AI and reasoning-driven systems  
- Emotion recognition & recommendation frameworks  

💻 Tech Stack:
`Python` · `SQL` · `Node.js`  · `JavaScript` · `HTML/CSS` · `Hadoop` · `Spark`
